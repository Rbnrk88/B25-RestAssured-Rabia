...
import com.cydeo.utilities.SpartenTestbase;
...
public class SpartanTestWithParamaters extends SpartenTestbase {
   ...
   /*
    ...
    public void test2() {
        ...
        Response response = given().log().all()//consolda herseyi gosterir.effect yapmaz kod icinde.
                .accept(ContentType.JSON)
                .and()
                .pathParam("id", 500)
                .when()
    ...
    //we search for "e", but verify with "Janette"
