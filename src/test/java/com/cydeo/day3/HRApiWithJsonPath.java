...
public class HRApiWithJsonPath extends HRTestBase{
    ...
    public void test2(){
        ...
        //get me  the first name of who is making the lowest salary
        String mminSalary = jsonPath.getString("items.min {it.salary}.first_name");
        System.out.println(mminSalary);
